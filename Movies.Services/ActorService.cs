...
namespace Movies.Services
{
    public class ActorService : IActorService
    {
        ...
        public async Task<Actor?> GetAsync(Guid id, bool trackChanges = false, params Expression<Func<Actor, object>>[] includes)
            => await uow.Actors.GetAsync(id, trackChanges, includes);
